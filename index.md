...
| ------- | ----------- | ----- | ---- |
| **SDG RAG System** | Retrieval-Augmented Generation system for UN SDG documents using HyDE + Chroma + reranking. | Python, LangChain, Streamlit | <ul><li>[Overview](/projects/SDG-RAG-System.md)</li><li>[Repo](https://github.com/philiphkw/SDG-RAG-System)</li></ul> |
